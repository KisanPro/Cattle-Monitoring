...
class _VaccinationDashboardScreenState extends State<VaccinationDashboardScreen> {
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(hintText: 'e.g. KA-1989'),
                onChanged: (val) {
                  if (val.trim().toUpperCase() == 'KA-1989') {
                    _cattleNameController.text = 'Geetha';
                    _cattleAgeController.text = '4';
                    _cattleWeightController.text = '380';
                    _cattleBreedController.text = 'Hallikar';
                    _farmerLocationController.text = 'Karnataka';
                  }
                },
              ...
              TextFormField(
                ...
                onChanged: (val) {
                  if (val.trim().toLowerCase() == 'geetha') {
                    _cattleIdController.text = 'KA-1989';
                    _cattleAgeController.text = '4';
                    _cattleWeightController.text = '380';
                    _cattleBreedController.text = 'Hallikar';
                    _farmerLocationController.text = 'Karnataka';
  ...
  Widget _buildAiPredictionAlertsSection(VaccinationProvider provider) {
    final alerts = provider.getActiveAiAlerts();
