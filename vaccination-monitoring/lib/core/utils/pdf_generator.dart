                      ...
                      pw.Column(
                        ...
                        children: [
                          pw.RichText(
                            text: pw.TextSpan(
                              children: [
                                const pw.TextSpan(text: 'Cattle Name: ', style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
                          ...
                          pw.RichText(
                            text: pw.TextSpan(
                              children: [
                                const pw.TextSpan(text: 'Cattle ID: ', style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
                      ...
                      pw.Column(
                        ...
                        children: [
                          pw.RichText(
                            text: pw.TextSpan(
                              children: [
                                const pw.TextSpan(text: 'Total Vaccinations: ', style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
                          ...
                          pw.RichText(
                            text: pw.TextSpan(
                              children: [
                                const pw.TextSpan(text: 'Compliance Rate: ', style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
