...
def main():
    ...
    # Freeze backbone weights EXCEPT last_linear and last_bn to make it fast on CPU
    ...
    for epoch in range(1, epochs + 1):
        # Training Phase
        # In ArcFace/FaceNet, BN layers are kept in eval mode to prevent statistics corruption 
        # when training on small/biased datasets. But since we are training the projection layer, 
        # let's set backbone to eval() for frozen parts and keep it consistent.
        backbone.eval() 
        arcface_layer.train()
