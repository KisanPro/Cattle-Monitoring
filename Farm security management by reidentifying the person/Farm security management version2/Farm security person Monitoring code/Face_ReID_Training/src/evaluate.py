...
def main():
    ...
    splits_path = 'metadata/dataset_splits.pth'
    db_path = 'metadata/embeddings_db.pkl'
    checkpoint_path = 'models/best_checkpoint.pth'
    ...
    # Save graphical confusion matrix
    try:
        ...
        print("Seaborn not installed, skipping graphical confusion matrix.")
