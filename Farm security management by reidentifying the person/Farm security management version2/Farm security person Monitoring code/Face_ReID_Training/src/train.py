...
def get_splits(processed_dir, train_ratio=0.70, val_ratio=0.10, test_ratio=0.20):
...
def main():
    ...
    }, os.path.join('metadata', 'dataset_splits.pth'))
    ...
    for epoch in range(1, epochs + 1):
        ...
        if epoch_val_acc > best_val_acc:
            ...
            torch.save(checkpoint, os.path.join('models', 'best_checkpoint.pth'))
