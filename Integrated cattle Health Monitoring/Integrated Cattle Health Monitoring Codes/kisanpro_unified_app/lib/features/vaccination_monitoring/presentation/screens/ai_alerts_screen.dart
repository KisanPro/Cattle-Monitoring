...
class _AiAlertsScreenState extends State<AiAlertsScreen> {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          // 2. Real-Time Geo-Epidemiological Outbreak Radar
          _buildRegionalOutbreakRadar(),
  ...
  Widget _buildRegionalOutbreakRadar() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          const Text(
            '🚨 Foot-and-Mouth Disease (FMD) Serotype O/A Active Outbreak Wave',
            style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: Color(0xFF991B1B)),
          ),
          const SizedBox(height: 4),
          const Text(
            'State veterinary telemetry indicates active transmission clusters within 25 km of your farm. Execute ring-vaccination and restrict livestock movement.',
